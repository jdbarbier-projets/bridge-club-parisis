...
if ( ! function_exists( 'ct_ignite_filter_read_more_link' ) ) {
	function ct_ignite_filter_read_more_link( $custom = false ) {
		...
		if ( empty( $read_more_text ) ) {
			$output .= '<div class="more-link-wrapper"><a class="more-link" href="' . esc_url( get_permalink() ) . '">' . __( 'En savoir plus', 'ignite' ) . '<span class="screen-reader-text">' . esc_html( get_the_title() ) . '</span></a></div>';
		} else {
