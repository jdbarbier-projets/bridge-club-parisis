...
( function ( wp, $ ) {
	...
	api.myCustomizerPreview = {
		// Init
		init: function () {
			var self = this, parentID, is_home = zoom_comm.is_home, isMeta = zoom_comm.meta_sett, multiMenu = zoom_comm.multiplemenu, editLang = zoom_comm.edit, is_rtl = zoom_comm.is_rtl, is_ie8 = ( $.browser.msie && parseFloat($.browser.version) < 10 ? 'not-ready-edit' : 'ready-edit' );
			...
			this.preview.bind( 'active', function() {
				...
				*/
				...
				$('.goto, .previewer-edit, .previewer-each-action').bind('click', function(e) {
