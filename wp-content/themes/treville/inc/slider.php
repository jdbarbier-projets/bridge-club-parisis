...
function treville_slider_scripts() {
	...
	if ( true === $theme_options['slider_active'] && is_front_page() ) :
		...
		wp_enqueue_script( 'treville-slider', get_template_directory_uri() . '/js/slider.js', array( 'jquery-flexslider' ), '20170421' );

		// Register and enqueue slider CSS.
		wp_enqueue_style( 'treville-slider', get_template_directory_uri() . '/css/flexslider.css', array(), '20170421' );
