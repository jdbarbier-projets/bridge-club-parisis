...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class Treville_Customize_Header_Control extends WP_Customize_Control {
		/**
		 * Render Control
		 */
	 ...
	 */
	class Treville_Customize_Description_Control extends WP_Customize_Control {
		/**
		 * Render Control
		 */
		public function render_content() {
	 ...
	 */
	class Treville_Customize_Category_Dropdown_Control extends WP_Customize_Control {
		/**
		 * Render Control
		 */
		public function render_content() {
			...
			if ( ! empty( $categories ) ) : ?>
					...
					<label>
						...
						<select <?php $this->link(); ?>>
							<option value="0"><?php esc_html_e( 'All Categories', 'treville' ); ?></option>
						<?php
	 ...
	 */
	class Treville_Customize_Upgrade_Control extends WP_Customize_Control {
		/**
		 * Render Control
		 */
		public function render_content() {
			...
			<div class="upgrade-pro-version">
				...
				<span class="customize-control-title"><?php esc_html_e( 'Pro Version Add-on', 'treville' ); ?></span>
				...
				<p>
					<a href="<?php echo esc_url( __( 'https://themezee.com/addons/treville-pro/', 'treville' ) ); ?>?utm_source=customizer&utm_medium=button&utm_campaign=treville&utm_content=pro-version" target="_blank" class="button button-secondary">
			...
			<div class="upgrade-plugins">
				...
				<span class="customize-control-title"><?php esc_html_e( 'Recommended Plugins', 'treville' ); ?></span>
