...
?>
  ...
  <div class="author-info vcard author-<?php echo esc_attr(get_the_author_meta( 'ID' ));?>">
    ...
    <div class="author-description">
      <h3 class="author-title"> <strong><a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta( 'ID' )));?>" title="<?php echo esc_attr( 'Posts by', 'canary' );?> <?php  echo esc_attr( get_the_author_meta('display_name'));?>" rel="author" class="author url fn">
